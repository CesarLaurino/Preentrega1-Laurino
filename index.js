...
AnimalHoroscopo = new AnimalHoroscopo ( "Mono", "Tierra", "Saturno", "Amarillo", "Encanto e Inquietud", "El Centro","Obsidiana")
...
function horoscopo (){
    ...
    if (masInfo === "si"){
        ...
        if (fecha === rata){
            ...
            AnimalHoroscopo = new AnimalHoroscopo ( "Rata", "Aire", "Mercurio", "Negro", "Intuición y Sencibilidad", "El Norte","Zafiro")
